...
## NVIDIA TAO OCR Pipeline

See [NVIDIA_OCR_ARCHITECTURE.md](NVIDIA_OCR_ARCHITECTURE.md), [NVIDIA_TAO_SETUP.md](NVIDIA_TAO_SETUP.md), [NVIDIA_DATA_ANNOTATION.md](NVIDIA_DATA_ANNOTATION.md), [NVIDIA_TRAINING.md](NVIDIA_TRAINING.md), [NVIDIA_EXPORT_AND_DEPLOYMENT.md](NVIDIA_EXPORT_AND_DEPLOYMENT.md), and [NVIDIA_OCR_TEST_REPORT.md](NVIDIA_OCR_TEST_REPORT.md) for the opt-in NVIDIA TAO OCDNet/OCRNet pipeline. RapidOCR remains the default production scanner.
