  ...
  return (
    <div className="screen sub-screen">
      <div className="sub-hero">
        <h2><i aria-hidden="true">⏰</i>{subStatus.title}</h2>
      </div>

      <div className="sub-card">
        <div className="sub-row">
          <span className="sub-label"><i aria-hidden="true">●</i>Status</span>
        ...
        <div className="sub-row">
          <span className="sub-label"><i aria-hidden="true">✉️</i>Contact</span>
